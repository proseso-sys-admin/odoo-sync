...
- Build: `docker build -t odoo-sync-worker .`
- Or use Cloud Build; push to Artifact Registry and deploy as a Cloud Run Service (or Job invoked by Cloud Scheduler every 5 min).
