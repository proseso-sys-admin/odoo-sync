...
```powershell
gcloud services enable secretmanager.googleapis.com --project=odoo-ocr-487104
$PN = (gcloud projects describe odoo-ocr-487104 --format="value(projectNumber)")
$SA = "service-$PN@gcp-sa-cloudbuild.iam.gserviceaccount.com"
gcloud projects add-iam-policy-binding odoo-ocr-487104 `
...
$PROJECT_ID = "odoo-ocr-487104"   # e.g. odoo-ocr-487104
